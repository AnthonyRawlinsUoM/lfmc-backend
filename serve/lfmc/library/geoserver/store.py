...
import serve.lfmc.library.geoserver.workspace as ws
from serve.lfmc.library.geoserver.resource import featuretype_from_index, coverage_from_index, \
    wmslayer_from_index
from serve.lfmc.library.geoserver.support import ResourceInfo, xml_property, key_value_pairs, \
...
class UnsavedWmsStore(WmsStore):
    ...
    def __init__(self, catalog, name, workspace, user, password):
        super(UnsavedWmsStore, self).__init__(
            catalog, workspace, name, user, password)
        metadata = {}
